...
const AgentPropertyDetails = ({ params }) => {
  // Get the property ID from the URL parameters
  // const { id: propertyId } = use(params);
  const param = useParams();
  console.log('param', param.propertyDetailsById);
  const propertyId = param.propertyDetailsById;
...
// export default AgentAgentPropertyDetails;
