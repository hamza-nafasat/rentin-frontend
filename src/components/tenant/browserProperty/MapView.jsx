  ...
  return (
    <div className="pt-5">
      <div className="grid grid-cols-12 gap-4">
        <div className="custom-scroll col-span-12 h-[calc(100vh-400px)] space-y-3 overflow-auto rounded-lg md:col-span-4 xl:h-[calc(100vh-355px)]">
          {houses?.map(property => (
        ...
        <div className="col-span-12 h-[calc(100vh-400px)] rounded-lg md:col-span-8 xl:h-[calc(100vh-355px)]">
          <AreaMapLocation
            houses={houses}
            areaName="Bangkok',
"
