...
function ListView({ handleCloseSlider, handleCardClick, selectedProperty, houses }) {
  ...
  return (
    <div className="grid h-[calc(100vh-375px)] grid-cols-1 gap-6 overflow-y-scroll pt-5 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4">
      ...
      {isModalOpen1 && (
        <Modal width={'w-full sm:w-[550px]'} onClose={() => handleModalClose(setIsModalOpen1)} title="Visit Request">
          <Content2
            ...
            onCancel={() => handleModalClose(setIsModalOpen1)}
          />
        </Modal>
      )}
      {isModalOpen2 && (
        <Modal
          ...
          onClose={() => handleModalClose(setIsModalOpen2)}
        ...
        >
          <Content4
            ...
            formData={formData}
            setFormData={setFormData}
            onBack={handleBackToContent1}
            onCancel={() => handleModalClose(setIsModalOpen2)}
          />
        </Modal>
      )}
      {isModalOpen3 && (
        <Modal
          ...
          onClose={() => handleModalClose(setIsModalOpen3)}
