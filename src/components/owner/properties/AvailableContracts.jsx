  ...
  return (
    <div className="mb-6">
      ...
      <div className="overflow-hidden rounded-lg bg-gray-50">
        {/* <div className="grid grid-cols-4 gap-4 bg-gray-100 p-4 text-sm font-medium text-gray-700">
          <div>Contract</div>
          <div>Price</div>
          <div>Duration</div>
        ...
        {contracts.map((contract, index) => (
          <div
            key={contract.id}
            className={`grid grid-cols-3 gap-4 border-b border-gray-200 p-4 transition-colors hover:bg-gray-50 md:grid-cols-2 ${
          ...
          >
            ...
            <div className="col-span-2 grid grid-cols-3 md:col-span-1">
              ...
              <div className="w-16 truncate text-gray-600 md:w-full">${contract.securityDeposit} Advance</div>
            </div>
          </div>
        ))}
      </div>
